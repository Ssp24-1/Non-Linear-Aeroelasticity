...
** No code was copied or taken directly from the book by any means. Programs were completely self made by viewing and solving the example problems by hand before which it was converted into python code. Any similarities with the code from the textbook is purely coincidental. 
